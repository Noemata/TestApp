...
namespace TestApp.ViewModels
{
    ...
    public class AboutViewModel : Screen, IViewAware
    {
        ...
        public AboutViewModel(IDialogWindowManager dialogWindowManager, IUserNotificationService userNotificationService)
        {
